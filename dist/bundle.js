...
var coinClickerDesc = "Coin Clicker is an incremental game where to make money, progress and " + "explore, you click the coin.";

var retailBossDesc = "Become the boss of a retail shop and lead it to success in this " + "real-time strategy game!";

var sparkRushDesc = "Spark Rush is a challenging, exciting arcade game. Take control of a " + "small spark and get as far as you can before being extinguished. ";
...
function Product(props) {
  ...
  var imageId = id + '-img';
  var imagePath = 'resources/images/' + name.toLowerCase().replace(' ', '_') + '.png';
  return _react2.default.createElement(
    'section',
    ...
    _react2.default.createElement(
      'a',
      { href: link },
      _react2.default.createElement('img', { id: imageId, src: imagePath })
    ),
    _react2.default.createElement(
      'p',
      null,
